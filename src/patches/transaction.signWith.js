...
function signWith(publicKey, transactionSigner) {
    return __awaiter(this, void 0, void 0, function () {
        var publicKeyData, publicKeyHex, payloads, _i, _a, signedTransaction, signatures, _b, _c, signedTransaction, bodyBytesHex, _d, _e, signature;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    publicKeyData = publicKey.toBytesRaw();
                    ...
                    payloads = [];
                    for (_i = 0, _a = this._signedTransactions.list; _i < _a.length; _i++) {
                        signedTransaction = _a[_i];
                        payloads.push(signedTransaction.bodyBytes);
                    }
                    return [4 /*yield*/, transactionSigner(payloads)];
                case 1:
                    signatures = _f.sent();
                    for (_b = 0, _c = this._signedTransactions.list; _b < _c.length; _b++) {
                        signedTransaction = _c[_b];
                        bodyBytesHex = Buffer.from(signedTransaction.bodyBytes).toString("hex");
                        ...
                        for (_d = 0, _e = signatures[bodyBytesHex]; _d < _e.length; _d++) {
                            signature = _e[_d];
