...
var DeployedContractsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDeployedContracts: function (pageCursor, pageSize, contractAddress, assetId, templateId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
    ...
    return {
        ...
        getDeployedContracts: function (pageCursor, pageSize, contractAddress, assetId, templateId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getDeployedContracts(pageCursor, pageSize, contractAddress, assetId, templateId, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
var DeployedContractsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
        ...
        getDeployedContracts: function (requestParameters, options) {
            ...
            return localVarFp.getDeployedContracts(requestParameters.pageCursor, requestParameters.pageSize, requestParameters.contractAddress, requestParameters.assetId, requestParameters.templateId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
