...
export declare const ContractInteractionsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getDeployedContractAbi: (contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    readCallFunction: (readCallFunctionDto: ReadCallFunctionDto, contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    writeCallFunction: (writeCallFunctionDto: WriteCallFunctionDto, contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ContractInteractionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getDeployedContractAbi(contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContractAbiResponseDto>>;
    /**
     * Call a read function on a deployed contract by blockchain native asset id and contract address
     * @summary Call a read function on a deployed contract
     * @param {ReadCallFunctionDto} readCallFunctionDto
     ...
     * @throws {RequiredError}
     */
    readCallFunction(readCallFunctionDto: ReadCallFunctionDto, contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ParameterWithValueList>>;
    /**
     * Call a write function on a deployed contract by blockchain native asset id and contract address. This creates an onchain transaction, thus it is an async operation. It returns a transaction id that can be polled for status check
     * @summary Call a write function on a deployed contract
     * @param {WriteCallFunctionDto} writeCallFunctionDto
     ...
     * @throws {RequiredError}
     */
    writeCallFunction(writeCallFunctionDto: WriteCallFunctionDto, contractAddress: string, assetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WriteCallFunctionResponseDto>>;
};
/**
