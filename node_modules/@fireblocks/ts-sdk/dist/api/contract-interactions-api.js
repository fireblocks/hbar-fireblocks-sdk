...
var ContractInteractionsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        getDeployedContractAbi: function (contractAddress, assetId, idempotencyKey, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('getDeployedContractAbi', 'assetId', assetId);
                    localVarPath = "/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions"
         ...
         * @throws {RequiredError}
         */
        readCallFunction: function (readCallFunctionDto, contractAddress, assetId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    ...
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('readCallFunction', 'assetId', assetId);
                    localVarPath = "/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions/read"
                        .replace("{".concat("contractAddress", "}"), encodeURIComponent(String(contractAddress)))
                        .replace("{".concat("assetId", "}"), encodeURIComponent(String(assetId)));
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
         ...
         * @throws {RequiredError}
         */
        writeCallFunction: function (writeCallFunctionDto, contractAddress, assetId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    ...
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('writeCallFunction', 'assetId', assetId);
                    localVarPath = "/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions/write"
                        .replace("{".concat("contractAddress", "}"), encodeURIComponent(String(contractAddress)))
                        .replace("{".concat("assetId", "}"), encodeURIComponent(String(assetId)));
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
    ...
    return {
        ...
        getDeployedContractAbi: function (contractAddress, assetId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getDeployedContractAbi(contractAddress, assetId, idempotencyKey, options)];
                        case 1:
        ...
        readCallFunction: function (readCallFunctionDto, contractAddress, assetId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.readCallFunction(readCallFunctionDto, contractAddress, assetId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        writeCallFunction: function (writeCallFunctionDto, contractAddress, assetId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.writeCallFunction(writeCallFunctionDto, contractAddress, assetId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
var ContractInteractionsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
        ...
        getDeployedContractAbi: function (requestParameters, options) {
            return localVarFp.getDeployedContractAbi(requestParameters.contractAddress, requestParameters.assetId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Call a read function on a deployed contract by blockchain native asset id and contract address
         * @summary Call a read function on a deployed contract
        ...
        readCallFunction: function (requestParameters, options) {
            return localVarFp.readCallFunction(requestParameters.readCallFunctionDto, requestParameters.contractAddress, requestParameters.assetId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Call a write function on a deployed contract by blockchain native asset id and contract address. This creates an onchain transaction, thus it is an async operation. It returns a transaction id that can be polled for status check
         * @summary Call a write function on a deployed contract
        ...
        writeCallFunction: function (requestParameters, options) {
            return localVarFp.writeCallFunction(requestParameters.writeCallFunctionDto, requestParameters.contractAddress, requestParameters.assetId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
...
var ContractInteractionsApi = /** @class */ (function (_super) {
    ...
    ContractInteractionsApi.prototype.getDeployedContractAbi = function (requestParameters) {
        var _this = this;
        return (0, exports.ContractInteractionsApiFp)(this.configuration).getDeployedContractAbi(requestParameters.contractAddress, requestParameters.assetId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Call a read function on a deployed contract by blockchain native asset id and contract address
     * @summary Call a read function on a deployed contract
