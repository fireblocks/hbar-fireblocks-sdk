...
export declare const ComplianceApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    updateScreeningConfiguration: (idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ComplianceApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    updateScreeningConfiguration(idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScreeningUpdateConfigurationsRequest>>;
    /**
     * Updates bypass screening, inbound delay, or outbound delay configurations for Travel Rule.
     * @summary Update Travel Rule Configuration
     * @param {string} [idempotencyKey] A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
...
export declare class ComplianceApi extends BaseAPI {
     ...
     * @memberof ComplianceApi
     */
    updateScreeningConfiguration(requestParameters?: ComplianceApiUpdateScreeningConfigurationRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ScreeningUpdateConfigurationsRequest>>;
    /**
     * Updates bypass screening, inbound delay, or outbound delay configurations for Travel Rule.
     * @summary Update Travel Rule Configuration
     * @param {ComplianceApiUpdateTravelRuleConfigRequest} requestParameters Request parameters.
