...
export declare const AuditLogsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAudits: (timePeriod?: GetAuditsTimePeriodEnum, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const AuditLogsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAudits(timePeriod?: GetAuditsTimePeriodEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetAuditLogsResponseDTO>>;
};
/**
...
export declare class AuditLogsApi extends BaseAPI {
     ...
     * @memberof AuditLogsApi
     */
    getAudits(requestParameters?: AuditLogsApiGetAuditsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<GetAuditLogsResponseDTO>>;
}
/**
 * @export
 */
 ...
 * @export
 */
export declare const GetAuditsTimePeriodEnum: {
    readonly Day: "DAY";
    readonly Week: "WEEK";
};
