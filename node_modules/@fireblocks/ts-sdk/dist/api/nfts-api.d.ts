 ...
 * @export
 */
export declare const NFTsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    getNFT: (id: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getNFTs: (ids: string, pageCursor?: string, pageSize?: number, sort?: Array<GetNFTsSortEnum>, order?: GetNFTsOrderEnum, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listOwnedCollections: (ncwId?: string, walletType?: ListOwnedCollectionsWalletTypeEnum, search?: string, pageCursor?: string, pageSize?: number, sort?: Array<ListOwnedCollectionsSortEnum>, order?: ListOwnedCollectionsOrderEnum, status?: ListOwnedCollectionsStatusEnum, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listOwnedTokens: (ncwId?: string, walletType?: ListOwnedTokensWalletTypeEnum, pageCursor?: string, pageSize?: number, sort?: Array<ListOwnedTokensSortEnum>, order?: ListOwnedTokensOrderEnum, status?: ListOwnedTokensStatusEnum, search?: string, spam?: ListOwnedTokensSpamEnum, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    refreshNFTMetadata: (id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateOwnershipTokens: (blockchainDescriptor: UpdateOwnershipTokensBlockchainDescriptorEnum, vaultAccountId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokenOwnershipStatus: (updateTokenOwnershipStatusDto: UpdateTokenOwnershipStatusDto, id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipSpam: (updateTokensOwnershipSpamRequest: UpdateTokensOwnershipSpamRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipStatus: (updateTokensOwnershipStatusRequest: UpdateTokensOwnershipStatusRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * NFTsApi - functional programming interface
 * @export
 */
export declare const NFTsApiFp: (configuration?: Configuration) => {
    /**
     * Returns the requested token data.
     * @summary List token data by ID
     * @param {string} id NFT ID
     ...
     * @throws {RequiredError}
     */
    getNFT(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenResponse>>;
    /**
     * Returns the requested tokens data.
     * @summary List tokens by IDs
     * @param {string} ids A comma separated list of NFT IDs. Up to 100 are allowed in a single request.
     ...
     * @throws {RequiredError}
     */
    getNFTs(ids: string, pageCursor?: string, pageSize?: number, sort?: Array<GetNFTsSortEnum>, order?: GetNFTsOrderEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetNFTsResponse>>;
    /**
     * Returns all tokens and their data in your workspace.
     * @summary List all owned tokens (paginated)
     * @param {GetOwnershipTokensBlockchainDescriptorEnum} [blockchainDescriptor] Blockchain descriptor filter
     ...
     * @throws {RequiredError}
     */
    refreshNFTMetadata(id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates all tokens and balances per blockchain and vault account.
     * @summary Refresh vault account tokens
     * @param {UpdateOwnershipTokensBlockchainDescriptorEnum} blockchainDescriptor Blockchain descriptor filter
     ...
     * @throws {RequiredError}
     */
    updateOwnershipTokens(blockchainDescriptor: UpdateOwnershipTokensBlockchainDescriptorEnum, vaultAccountId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates token status for a tenant, in all tenant vaults.
     * @summary Update token ownership status
     * @param {UpdateTokenOwnershipStatusDto} updateTokenOwnershipStatusDto
     ...
     * @throws {RequiredError}
     */
    updateTokenOwnershipStatus(updateTokenOwnershipStatusDto: UpdateTokenOwnershipStatusDto, id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates tokens spam property for a tenant\'s token ownerships, in all tenant vaults.
     * @summary Update tokens ownership spam property
     * @param {UpdateTokensOwnershipSpamRequest} updateTokensOwnershipSpamRequest
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipSpam(updateTokensOwnershipSpamRequest: UpdateTokensOwnershipSpamRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Updates tokens status for a tenant, in all tenant vaults.
     * @summary Update tokens ownership status
     * @param {UpdateTokensOwnershipStatusRequest} updateTokensOwnershipStatusRequest
     ...
     * @throws {RequiredError}
     */
    updateTokensOwnershipStatus(updateTokensOwnershipStatusRequest: UpdateTokensOwnershipStatusRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
 * NFTsApi - factory interface
 * @export
 */
export declare const NFTsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns the requested token data.
     * @summary List token data by ID
 ...
 * @extends {BaseAPI}
 */
export declare class NFTsApi extends BaseAPI {
    /**
     * Returns the requested token data.
     * @summary List token data by ID
     * @param {NFTsApiGetNFTRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    getNFT(requestParameters: NFTsApiGetNFTRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<TokenResponse>>;
    /**
     * Returns the requested tokens data.
     * @summary List tokens by IDs
     * @param {NFTsApiGetNFTsRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    getNFTs(requestParameters: NFTsApiGetNFTsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<GetNFTsResponse>>;
    /**
     * Returns all tokens and their data in your workspace.
     * @summary List all owned tokens (paginated)
     * @param {NFTsApiGetOwnershipTokensRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    getOwnershipTokens(requestParameters?: NFTsApiGetOwnershipTokensRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<GetOwnershipTokensResponse>>;
    /**
     * Returns all collections in your workspace
     * @summary List owned collections (paginated)
     * @param {NFTsApiListOwnedCollectionsRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    listOwnedCollections(requestParameters?: NFTsApiListOwnedCollectionsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ListOwnedCollectionsResponse>>;
    /**
     * Returns all owned distinct tokens (for your tenant) and their data in your workspace.
     * @summary List all distinct owned tokens (paginated)
     * @param {NFTsApiListOwnedTokensRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    listOwnedTokens(requestParameters?: NFTsApiListOwnedTokensRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ListOwnedTokensResponse>>;
    /**
     * Updates the latest token metadata.
     * @summary Refresh token metadata
     * @param {NFTsApiRefreshNFTMetadataRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    refreshNFTMetadata(requestParameters: NFTsApiRefreshNFTMetadataRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Updates all tokens and balances per blockchain and vault account.
     * @summary Refresh vault account tokens
     * @param {NFTsApiUpdateOwnershipTokensRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    updateOwnershipTokens(requestParameters: NFTsApiUpdateOwnershipTokensRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Updates token status for a tenant, in all tenant vaults.
     * @summary Update token ownership status
     * @param {NFTsApiUpdateTokenOwnershipStatusRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    updateTokenOwnershipStatus(requestParameters: NFTsApiUpdateTokenOwnershipStatusRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Updates tokens spam property for a tenant\'s token ownerships, in all tenant vaults.
     * @summary Update tokens ownership spam property
     * @param {NFTsApiUpdateTokensOwnershipSpamRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    updateTokensOwnershipSpam(requestParameters: NFTsApiUpdateTokensOwnershipSpamRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Updates tokens status for a tenant, in all tenant vaults.
     * @summary Update tokens ownership status
     * @param {NFTsApiUpdateTokensOwnershipStatusRequest} requestParameters Request parameters.
     ...
     * @memberof NFTsApi
     */
    updateTokensOwnershipStatus(requestParameters: NFTsApiUpdateTokensOwnershipStatusRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
}
/**
 * @export
 */
export declare const GetNFTsSortEnum: {
    readonly CollectionName: "collection.name";
    readonly Name: "name";
    readonly BlockchainDescriptor: "blockchainDescriptor";
};
export type GetNFTsSortEnum = typeof GetNFTsSortEnum[keyof typeof GetNFTsSortEnum];
/**
 * @export
 */
export declare const GetNFTsOrderEnum: {
    readonly Desc: "DESC";
    readonly Asc: "ASC";
};
 ...
 * @export
 */
export declare const GetOwnershipTokensBlockchainDescriptorEnum: {
    readonly Eth: "ETH";
 ...
 * @export
 */
export declare const GetOwnershipTokensWalletTypeEnum: {
 ...
 * @export
 */
export declare const GetOwnershipTokensSortEnum: {
    readonly OwnershipLastUpdateTime: "ownershipLastUpdateTime";
    readonly Name: "name";
    readonly CollectionName: "collection.name";
    readonly BlockchainDescriptor: "blockchainDescriptor";
};
 ...
 * @export
 */
export declare const GetOwnershipTokensOrderEnum: {
    readonly Desc: "DESC";
    readonly Asc: "ASC";
};
 ...
 * @export
 */
export declare const GetOwnershipTokensStatusEnum: {
 ...
 * @export
 */
export declare const GetOwnershipTokensSpamEnum: {
    readonly True: "true";
 ...
 * @export
 */
export declare const ListOwnedCollectionsWalletTypeEnum: {
    readonly VaultAccount: "VAULT_ACCOUNT";
    readonly EndUserWallet: "END_USER_WALLET";
};
 ...
 * @export
 */
export declare const ListOwnedCollectionsSortEnum: {
    readonly Name: "name";
};
 ...
 * @export
 */
export declare const ListOwnedCollectionsOrderEnum: {
    readonly Desc: "DESC";
    readonly Asc: "ASC";
};
 ...
 * @export
 */
export declare const ListOwnedCollectionsStatusEnum: {
    readonly Listed: "LISTED";
    readonly Archived: "ARCHIVED";
};
 ...
 * @export
 */
export declare const ListOwnedTokensWalletTypeEnum: {
    readonly VaultAccount: "VAULT_ACCOUNT";
    readonly EndUserWallet: "END_USER_WALLET";
};
 ...
 * @export
 */
export declare const ListOwnedTokensSortEnum: {
    readonly Name: "name";
};
 ...
 * @export
 */
export declare const ListOwnedTokensOrderEnum: {
    readonly Desc: "DESC";
    readonly Asc: "ASC";
};
 ...
 * @export
 */
export declare const ListOwnedTokensStatusEnum: {
    readonly Listed: "LISTED";
    readonly Archived: "ARCHIVED";
};
 ...
 * @export
 */
export declare const ListOwnedTokensSpamEnum: {
    readonly True: "true";
    readonly False: "false";
    readonly All: "all";
};
 ...
 * @export
 */
export declare const UpdateOwnershipTokensBlockchainDescriptorEnum: {
    readonly Eth: "ETH";
    readonly EthTest5: "ETH_TEST5";
    readonly EthTest6: "ETH_TEST6";
    readonly Polygon: "POLYGON";
